                ...
                m("div.uk-margin-small-left uk-margin-small-bottom uk-margin-small-top uk-margin-small-right uk-flex uk-flex-row uk-flex-middle uk-flex-between",[
                    ...
                    m("div",[
                        m("div.uk-button-group",[
                            m("button.uk-button uk-button-primary",{onclick:function(){ProjectController.add();}},"NEW_PROJECT")
                        ])
                    ])
                ]),
									...
									m("div.uk-card uk-card-default uk-width-1-1",[
										...
										m("div.uk-card-body",[
											m("div.uk-form-stacked",[
												m("div.uk-margin",[
													m("label.uk-form-label","TITUL"),
													m("input.uk-input",{placeholder:"TITUL", oninput: m.withAttr("value",function(value){Project.current.name = value;}),value:Project.current.name})
												]),
												m("div.uk-margin",[
													m("label.uk-form-label","SITE"),
													m("input.uk-input",{placeholder:"SITE", oninput: m.withAttr("value",function(value){Project.current.url = value;}),value:Project.current.url})
												]),
												m("div.uk-margin",[
													m("label.uk-form-label","CLIENT"),
												...
												m("div.uk-margin",[
													...
													m("div.uk-button-group",[
														m("input.uk-input",{placeholder:"Название",value:Project.tag.new.name, oninput: m.withAttr("value",function(value){
															if(value.length >= 3){
														...
														m("button.uk-button uk-button-primary",{onclick:function(){{ProjectController.addTag(false);}}},"Добавить"),
													]),
													m('ul.uk-list',[
